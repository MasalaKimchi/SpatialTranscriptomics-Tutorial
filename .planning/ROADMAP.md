...
- [ ] **Phase 1: Offline Verification Harness** - Establish representative, tiered, CPU/offline evidence for every later reliability change.
...
|-------|----------------|--------|-----------|
| 1. Offline Verification Harness | 0/TBD | Not started | - |
