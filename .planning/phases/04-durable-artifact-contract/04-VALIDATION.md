...
- [ ] `projects/spatial-pharma-dl/tests/test_artifact_contract.py` — pure manifest, fingerprint, checksum, hostile admission, and atomic fault-injection evidence.
- [ ] `projects/spatial-pharma-dl/tests/test_artifact_adapters.py` — real tiny H5AD/NPZ/table/checkpoint production-reader schema and lineage evidence.
- [ ] `projects/spatial-pharma-dl/tests/test_artifact_orchestration.py` — regeneration, runner publication, bypass inventory, and compatibility evidence.
