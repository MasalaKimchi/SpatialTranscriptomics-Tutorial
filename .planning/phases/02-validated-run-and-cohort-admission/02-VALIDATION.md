...
|---------|------|------|-------------|------------|-----------------|-----------|-------------------|-------------|--------|
| 2-01-01 | 01 | 1 | VAL-01 | T-01 | Aggregated config issues block all side effects | unit | `python -m pytest -q -m offline projects/spatial-pharma-dl/tests/test_validation.py` | ❌ W0 | ⬜ pending |
| 2-01-02 | 01 | 1 | VAL-01 | T-02 | Canonical config is deterministic and JSON-safe | unit | `python -m pytest -q -m offline projects/spatial-pharma-dl/tests/test_validation.py` | ❌ W0 | ⬜ pending |
| 2-02-01 | 02 | 2 | VAL-04 | T-03 | Strict admission aggregates missing slides before processing | integration | `python -m pytest -q -m offline projects/spatial-pharma-dl/tests/test_cohort_admission.py` | ❌ W0 | ⬜ pending |
| 2-02-02 | 02 | 2 | VAL-04 | T-04 | Explicit partial mode records every configured/included/skipped/failed slide | integration | `python -m pytest -q -m offline projects/spatial-pharma-dl/tests/test_cohort_admission.py` | ❌ W0 | ⬜ pending |
| 2-03-01 | 03 | 3 | VAL-03 | T-05 | Empty public-boundary inputs fail before expensive work | unit/integration | `python -m pytest -q -m offline projects/spatial-pharma-dl/tests/test_empty_boundaries.py` | ❌ W0 | ⬜ pending |
| 2-03-02 | 03 | 3 | VAL-01, VAL-03, VAL-04 | — | Existing compatibility and the complete offline suite remain green | regression | `python scripts/verify.py fast` | ✅ | ⬜ pending |
